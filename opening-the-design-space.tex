...
% - Draws on experiences across all instruments, especially the intelligent DAW and setups
% - Links to HCI literature on mapping flexibility and co-creative AI systems
% - Design implication: Enabling runtime remapping allows artists to discover productive AI interactions without retraining

\subsection{Embodied Understanding Through Multi-Interface Control}

% - Focuses on QuNeo/S-1 setup and DAW experiences where multiple control surfaces shaped interaction
% - Connects to embodied interaction literature and your HCI/computer music background
% - Design implication: Multiple simultaneous interfaces provide varied gestural affordances for managing AI behavior

\subsection{Co-creative dynamics}

% - Examines the call-and-response mechanism across MicroFreak, S-1, and intelligent setups
% - Links to Parkinson & Dunning's taxonomy, interactive music systems literature
% - Design implication: Sub-second response times enable interleaved human-AI control that feels collaborative rather than oppositional

\subsection{AI Models as a Transportable Instrument Component}



% - Addresses your 1-hour corpus training approach vs large-scale AI
% - Connects to Vigliensoni's small data concept and ethical AI concerns you raise
% - Design implication: Artist-centered data collection/training enables personalized rather than generic AI behaviors
