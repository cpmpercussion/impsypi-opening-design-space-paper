...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{outside-1.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{desk-shot.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{sf-image.jpg}
...
Although we have configured our system to generate one dimension of musical data (in addition to time deltas), the MDRNN architecture can support multiple dimensions of data and could control different MIDI values or channels simultaneously in other applications. The source code for our system is open source and available for use and modification by other instrument designers: \anonymize{https://github.com/cpmpercussion/empi/tree/midiserial}.
